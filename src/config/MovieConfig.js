...
export const getMovieById = (id) => {
  return api.get(`/movie/public/${id}`)
...
export const searchGenres = (name) => {
  return api.get(`/movie/genre/search?name=${name}`)
  .then(response => response.data)
  .catch(error => {
    console.error("Error getAllGenres", error);
    return null;
...
export const addGenre = (genre) => {
  return api.post('/movie/genre/add', genre)
  .then(response => response.data)
  .catch(error => {
...
export const updateGenre = (id, genreDetails) => {
  return api.put(`/movie/genre/${id}`, genreDetails)
  .then(response => response.data)
  .catch(error => {
...
export const hideGenre = (id) => {
  return api.put(`/movie/genre/${id}/hide`)
  .then(response => response.data)
  .catch(error => {
...
export const searchMovies = (title) => {
  return api.get('/movie/search', { params: { title } })
  .then(response => response.data)
  .catch(error => {
...
export const searchMoviesByGenre = (genreName) => {
  return api.get('/movie/searchByGenre', { params: { genreName } })
  .then(response => response.data)
  .catch(error => {
...
export const addMovie = (movie) => {
  return api.post('/movie/add', movie)
  .then(response => response.data)
  .catch(error => {
...
export const updateStatusMovie = (id) => {
  return api.put(`/movie/update-status/${id}`)
  .then(response => response.data)
  .catch(error => {
