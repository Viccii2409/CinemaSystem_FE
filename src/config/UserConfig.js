...
export const verifyaccount = async (account) => {
  return api
    .post("/user/public/verifyaccount", account)
    .then((response) => response.data)
    .catch((error) => {
...
export const forgotPassword = async (email) => {
  return api
    .get(`/user/public/forgotpassword/${email}`)
    .then((response) => response.data)
    .catch((error) => {
...
export const changePasswordCustomer = async (data) => {
  return api
    .put("/user/public/changepassword", data)
    .then((response) => response.data)
    .catch((error) => {
...
export const checkEmployee = async (email) => {
  console.log(email);
  return api
    .post("/user/employee/check", { username: email })
    .then((response) => response.data)
    .catch((error) => {
...
export const addEmployee = async (employee) => {
  return api
    .post("/user/employee/add", employee)
    .then((response) => response.data)
    .catch((error) => {
...
export const updateEmployee = async (employee) => {
  return api
    .put("/user/employee/update", employee)
    .then((response) => response.data)
    .catch((error) => {
...
export const updateStatusEmployee = async (id) => {
  return api
    .put(`/user/employee/${id}/updatestatus`)
    .then((response) => response.data)
    .catch((error) => {
...
export const addGenreFauvorite = async (data) => {
  return api
    .post("/user/customer/genre/add", data)
    .then((response) => response.data)
    .catch((error) => {
